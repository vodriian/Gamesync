...
export function GameCard({ game, index }: GameCardProps) {
  ...
  return (
    ...
    >
      <Card className="group overflow-hidden border-border/50 bg-card/40 backdrop-blur-sm hover:border-primary/50 hover:bg-card/60 transition-all duration-300">
